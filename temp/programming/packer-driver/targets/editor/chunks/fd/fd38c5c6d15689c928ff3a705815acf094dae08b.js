    ...
    execute: function () {
      ...
      _export("shoot", shoot = (_dec = ccclass('shoot'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Label), _dec(_class = (_class2 = class shoot extends Component {
        ...
        onclickshoot(evt) {
          ...
          let addbullet = instantiate(this.bulletPrefab); //在場景中新增節點
          ...
          this.hittime(addbullet, this.enemy);
        }

        collision(addbullet, enemy) {
          let dist = addbullet.position.sub(enemy.position).mag();
          return dist;
        }
...
//# sourceMappingURL=fd38c5c6d15689c928ff3a705815acf094dae08b.js.map