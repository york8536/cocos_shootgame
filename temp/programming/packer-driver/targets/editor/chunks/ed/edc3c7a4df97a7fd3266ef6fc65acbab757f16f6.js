System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Component, instantiate, Node, Prefab, Animation, Label, Canvas, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _crd, ccclass, property, shoot;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("shoot", shoot = (_dec = ccclass('shoot'), _dec2 = property(Button), _dec3 = property(Canvas), _dec4 = property(Canvas), _dec5 = property(Canvas), _dec6 = property(Prefab), _dec7 = property(Node), _dec8 = property(Label), _dec(_class = (_class2 = class shoot extends Component {
        constructor(...args) {
          super(...args);
        ...
        startgame() {
          // 按下開始後隱藏start畫面
          this.StartCanvas.enabled = false; // 10秒後隱藏game畫面
...
//# sourceMappingURL=edc3c7a4df97a7fd3266ef6fc65acbab757f16f6.js.map