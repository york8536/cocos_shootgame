System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Component, instantiate, Node, Prefab, Animation, Label, Canvas, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, shoot;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("shoot", shoot = (_dec = ccclass('shoot'), _dec2 = property(Button), _dec3 = property(Canvas), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(Label), _dec(_class = (_class2 = class shoot extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "enemy", _descriptor4, this);

          _initializerDefineProperty(this, "hitcount", _descriptor5, this);
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "enemy", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "hitcount", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=09324a517b6bc544b903e7ad2a8976022f184178.js.map