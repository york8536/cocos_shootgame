System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Component, instantiate, Node, Prefab, Animation, Label, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, shoot;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("shoot", shoot = (_dec = ccclass('shoot'), _dec2 = property(Button), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Prefab), _dec7 = property(Node), _dec8 = property(Label), _dec9 = property(Label), _dec(_class = (_class2 = class shoot extends Component {
        constructor(...args) {
          super(...args);

          _initializerDefineProperty(this, "Start", _descriptor, this);

          _initializerDefineProperty(this, "startview", _descriptor2, this);

          _initializerDefineProperty(this, "gameview", _descriptor3, this);

          _initializerDefineProperty(this, "endview", _descriptor4, this);
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "startview", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "gameview", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "endview", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=511d3a2530ee4b9bff3733b4d3d4cdda7fc3cee6.js.map