    ...
    execute: function () {
      ...
      _export("shoot", shoot = (_dec = ccclass('shoot'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Label), _dec(_class = (_class2 = class shoot extends Component {
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "hitcount", _descriptor3, this);
        ...
        onLoad() {
          // 將HIT字串設定為空值
          this.hitcount.string = "132"; // 將bulletAry陣列設定為空值
        ...
        onclickshoot(evt) {
          console.log("Shoot");
          let addbullet = instantiate(this.bulletPrefab); // 複製bulletPrefab(子彈)

          this.node.addChild(addbullet); // 在場景中新增子彈節點

          let bulletAni = addbullet.getComponent(Animation); // 子彈消失
          // 從場景中移除子彈動畫節點
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "hitcount", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=b5f0382141d2dee186bd577e235e16091e71c14e.js.map